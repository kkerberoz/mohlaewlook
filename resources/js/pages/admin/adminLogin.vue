      ...
      <div class="col-md-3">
        <form v-on:submit="formSubmit">
          <div class="card" id="cardLogin">
            <div class="card-header bg-dark" id="cardLogin">Admin Login</div>
            <div class="card-body">
            ...
            <div class="card-footer" id="cardLogin">
              <button id="btnLogin" type="submiit" class="btn btn-block btn-login">Sign in</button>
              <button @click="home" id="btnLogin2" class="btn btn-block btn-login">HOME</button>
            </div>
          </div>
        </form>
      </div>
              ...
              swal
                ...
                .then(() => {
                  if (response.data.employee_role === "staff") {
                    ...
                    response.data.employee_role === "flight_attendant"
                  ) {
                    localStorage.setItem("isAdmin", "true");
