                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <span class="col-md-4 mb-2">
                                    <label>Brand:</label>
                                    <input
                                        v-bind:class="{'is-invalid': error_brand}"
                                        @input="checkBrand"
                                        type="text"
                                        class="form-control"
                                        v-model="input.brand"
                                ...
                                <span class="col-md-4 mb-2">
                                    <label>Country:</label>
                                    <input
                                        v-bind:class="{'is-invalid': error_country}"
                                        type="text"
                                        class="form-control"
                                ...
                                <span id="watch-example" class="col-md-4 mb-2">
                                    <label>Model:</label>
                                    <input
                                        v-bind:class="{'is-invalid': error_model}"
                                        @input="checkModel"
                                        type="text"
                                        class="form-control"
                                        v-model="input.model"
                            ...
                            <div class="row">
                                <span class="col-md-4 mb-2">
                                    ...
                                    <input
                                        v-bind:class="{'is-invalid': error_fuelCap}"
                                        type="text"
                                        class="form-control"
                                ...
                                <span class="col-md-4 mb-2">
                                    ...
                                    <input
                                        v-bind:class="{'is-invalid': error_numberEng}"
                                        type="text"
                                        class="form-control"
                                ...
                                <span class="col-md-4 mb-2">
                                    ...
                                    <input
                                        v-bind:class="{'is-invalid': error_typeEng}"
                                        type="text"
                                        class="form-control"
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input
                                        v-bind:class="{'is-invalid': error_ecoCap}"
                                        type="text"
                                        class="form-control"
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input
                                        v-bind:class="{'is-invalid': error_busCap}"
                                        type="text"
                                        class="form-control"
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input
                                        v-bind:class="{'is-invalid': error_firstCap}"
                                        type="text"
                                        class="form-control"
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input
                                        v-bind:class="{'is-invalid': error_ecoPat}"
                                        type="text"
                                        class="form-control"
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input
                                        v-bind:class="{'is-invalid': error_busPat}"
                                        type="text"
                                        class="form-control"
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input
                                        v-bind:class="{'is-invalid': error_firstPat}"
                                        type="text"
                                        class="form-control"
...
export default {
    ...
    methods: {
        handleFormCilcked(e) {
            ...
            {
                this.isLoading = true;
                axios.post("/api/backend/addAircraft", data)
                .then(response => {
